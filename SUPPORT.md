...
Suspected vulnerabilities follow [SECURITY.md](SECURITY.md) and must not be public. Snowflake
product behavior, account access, billing, and incidents belong in official Snowflake support
channels. This independent package is not sponsored, endorsed, supported, or maintained by
Snowflake Inc.; a `snowflake.com` contact address does not create affiliation.