...
{% macro cortex_agent__route_alias_for_fqn(agent_fqn, to_version, alias, expected_alias_version='') %}
...
{% macro cortex_agent__route_alias(agent_name, to_version, alias, expected_alias_version='') %}
  ...
  {{ return(dbt_cortex_agent.cortex_agent__route_alias_for_fqn(agent_fqn, to_version, alias, expected_alias_version)) }}
{% endmacro %}

{% macro cortex_agent__route_default(agent_name, to_version, expected_default_version) %}
...
{% macro cortex_agent__route_version(agent_name, to_version, alias, set_default=false) %}
  ...
  {% set alias_result = dbt_cortex_agent.cortex_agent__route_alias(agent_name, to_version, alias, expected_alias_version) %}
  {% if set_default %}
    {% set default_result = dbt_cortex_agent.cortex_agent__route_default(agent_name, to_version, before.get('default_version', '')) %}
  {% endif %}
  {{ return(alias_result) }}
{% endmacro %}

{% macro cortex_agent__drop(agent_name) %}
