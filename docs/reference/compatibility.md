...
This matrix applies to `dbt_cortex_agent` 0.0.7 on both install surfaces.

The project-local Cortex Code adoption skill uses the same 0.0.7 CLI/parser and
...
It ships in the same v0.0.7 release scope as the generic and Orders scaffolds,
