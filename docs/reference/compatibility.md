...
This matrix applies to `dbt_cortex_agent` 0.0.5 on both install surfaces.

The project-local Cortex Code adoption skill uses the same 0.0.5 CLI/parser and
...
It ships in the same v0.0.5 release scope as the Orders starter,
